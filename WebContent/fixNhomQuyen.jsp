	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="widget">
			...
			<div class="formRow">
				...
				<div class="formRight"> 
					<div class="col-xs-6">
	        			<input class="form-control" id="tenNhom" type="text" value="Nhân viên 1">
					</div>
			...
			<div class="formRow" style="height: 110px" >
				<label> Mô tả </label>
				<div class="formRight"> 
				<textarea rows="4" cols="80" class="tipS" name="moTaNhomQuyen"> Quản lý đơn hàng và sản phẩm </textarea>
				</div>
			</div>
			<div class="formRow" style="height: 200px">
	        	<label>Phân quyền</label>
	           	...
	           	<div class="checkbox">
				  <label><input type="checkbox" value="" checked>Quản lý sản phẩm</label>
				</div>
				<div class="checkbox">
				  <label><input type="checkbox" value="" checked>Quản lý đơn hàng</label>
				</div>
				<div class="checkbox">
